    ...
    >
        ...
        {topItems.map((item) => {
          ...
          return (
            ...
            >
              ...
              />
              <div
                className={`absolute left-full ml-2 px-2 py-1 text-xs rounded whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none z-50 border shadow-md ${isLight
      ...
      <div className="flex flex-col items-center gap-0.5 pb-1">
        ...
        >
          ...
          />
          <TerminalIcon
            className={`w-6 h-6 transition-colors ${terminalVisible
              ? isLight
                ? 'text-[#005fb8]'
                : 'text-white'
              : isLight
        ...
        >
          ...
          />
          <UserCircle
            className={`w-6 h-6 transition-colors ${activeSidebarPanel === 'profile' && sidebarVisible
              ? isLight
                ? 'text-[#005fb8]'
                : 'text-white'
              : isLight
        ...
        >
          ...
          />
          <Settings
            className={`w-6 h-6 transition-transform duration-300 ${activeSidebarPanel === 'settings' && sidebarVisible
              ? isLight
